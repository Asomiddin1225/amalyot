...
ekran Razmeri o'zgarsa ichidagi barch ma'lumodlar o'zgarsin
  ...
  contenor(
    width: 100,
              ...
              decoration: BoxDecoration(
                ...
                o'ng tomon pasgi burchagi BorderRadius.circular(40)
              ),
               child: Image.network(
                      "30.jpg",
                      fit: BoxFit.cover,va contenor(coration: BoxDecoration(
                color: Colors.whith,
                borderRadius: BorderRadius.circular(100),Icon play
